...
const ko = {
  ...
  admin: {
    ...
    settings: {
      ...
      password: '비밀번호',
      tags: '태그',
      mobileDestination: '모바일 목적지',
      desktopDestination: '데스크톱 목적지',
      abDestination: 'A/B 목적지',
      abPercentage: 'A/B 비율',
  ...
  messages: {
    ...
    abOptionDenied: 'A/B 테스트 옵션을 사용할 권한이 없습니다.',
...
const en: typeof ko = {
  ...
  admin: {
    ...
    settings: {
      ...
      password: 'Password',
      tags: 'Tags',
      mobileDestination: 'Mobile destination',
      desktopDestination: 'Desktop destination',
      abDestination: 'A/B destination',
      abPercentage: 'A/B percentage',
  ...
  linkOptions: {
    ...
    abUrl: 'A/B destination',
    abPercent: 'A/B percentage',
    tags: 'Tags',
    commaSeparated: 'Comma-separated',
    mobileUrl: 'Mobile destination',
    desktopUrl: 'Desktop destination',
  },
  managedLinks: {
  ...
  messages: {
    ...
    abOptionDenied: 'You do not have permission to use A/B test options.',
