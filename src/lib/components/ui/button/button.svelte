  ...
  export const buttonVariants = tv({
    ...
    variants: {
      variant: {
        ...
        secondary:
          'bg-secondary text-secondary-foreground hover:bg-[color-mix(in_oklch,var(--ui-muted),var(--ui-foreground)_5%)] aria-expanded:bg-secondary aria-expanded:text-secondary-foreground',
        ghost:
...
{#if href}
  <!-- The caller resolves application paths; external hrefs are supported. -->
