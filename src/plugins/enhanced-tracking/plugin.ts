...
const plugin: PluginDefinition = {
  ...
  translations: {
    ...
    en: {
      ...
      strings: {
        ...
        'admin.city': 'City',
        'admin.asn': 'ASN',
        'admin.showToAdmins': 'Show to administrators',
  ...
  parseConfig(form) {
    return normalizeEnhancedTrackingConfig({
      ...
      showCountry: pluginChecked(form, 'enhanced-tracking', 'showCountry'),
      exposeCountryToUsers: pluginChecked(
        form,
        'enhanced-tracking',
        'exposeCountryToUsers',
      ),
      showCity: pluginChecked(form, 'enhanced-tracking', 'showCity'),
      exposeCityToUsers: pluginChecked(
        form,
        'enhanced-tracking',
        'exposeCityToUsers',
      ),
      showAsn: pluginChecked(form, 'enhanced-tracking', 'showAsn'),
